# Домашнее задание к занятию "`12.5 Индексы `" - `Станкевич Андрей`
...
```
Узкое место - использование Distinct, объединение с группировкой по не относящемся полям c.customer_id, f.title
Как улучшить - использовать агрегатную функцию с группировкой по имени_фамилии и отказ от использования таблицы film f. делает использование запроса ликвидным
